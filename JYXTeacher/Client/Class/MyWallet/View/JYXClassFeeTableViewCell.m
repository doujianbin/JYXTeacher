...
@interface JYXClassFeeTableViewCell ()
...
@implementation JYXClassFeeTableViewCell
...
{
    if (!model) return;
    self.titleLabel.text = [NSString stringWithFormat:@"%@ %@ %@",model[@"name"],model[@"grade"],model[@"subject"]];
