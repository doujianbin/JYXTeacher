...
@interface JYXEducationApproveView ()
...
@implementation JYXEducationApproveView
...
- (UILabel *)subTitleLabel
{
    if (!_subTitleLabel) {
        ...
        _subTitleLabel.text = NSLocalizedString(@"学历认证必填", nil);
...
- (UILabel *)remarkLabel
{
    if (!_remarkLabel) {
        ...
        _remarkLabel.text = NSLocalizedString(@"上传学位证 毕业证 学生证", nil);
