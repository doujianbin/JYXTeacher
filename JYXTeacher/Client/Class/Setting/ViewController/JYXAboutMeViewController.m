...
- (void)oncreate{
    UIImageView *img_icon = [[UIImageView alloc]initWithFrame:CGRectMake((SCREEN_WIDTH - 95) / 2, 60, 95, 125)];
    [self.view addSubview:img_icon];
    [img_icon setImage:[UIImage imageNamed:@"教予学LOGO"]];
...
//    [lb_title setTextAlignment:NSTextAlignmentCenter];
    ...
    _addressExplainLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, img_icon.bottom + 30, SCREEN_WIDTH - 60, 150)];
