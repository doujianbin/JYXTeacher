...
- (void)initDefaultConfig
{
    ...
    self.selectRowTitleAttribute = @{NSForegroundColorAttributeName : [UIColor colorWithHexString:@"#070707"], NSFontAttributeName : [UIFont systemFontOfSize:20.0f]};
    self.unSelectRowTitleAttribute = @{NSForegroundColorAttributeName : [UIColor colorWithHexString:@"a7a7a7"], NSFontAttributeName : [UIFont systemFontOfSize:20.0f]};
...
- (void)initSubViews
{
    ...
    [canceBtn setTitleColor:[UIColor colorWithHexString:@"#070707"] forState:UIControlStateNormal];
    ...
    [sureBtn setTitleColor:[UIColor colorWithHexString:@"#070707"] forState:UIControlStateNormal];
