...
{
    return [CALayer creatLineLayerWithFrame:CGRectMake(7, originY, ([UIScreen mainScreen].bounds.size.width - 7 - 7), 0.5) color:[UIColor colorWithHexString:@"#e3e3e3"]];
}

+ (CALayer *)navLineLayerWithOriginY:(CGFloat)originY
{
  return [CALayer creatLineLayerWithFrame:CGRectMake(0, originY, [UIScreen mainScreen].bounds.size.width, 0.5) color:[UIColor colorWithHexString:@"#e3e3e3"]];
}
