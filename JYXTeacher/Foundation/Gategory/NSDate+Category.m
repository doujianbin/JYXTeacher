...
/**
 ...
 @return 转换完成的时间
 */
+ (NSString *)dateConvertStringWithIntervalString:(NSString *)timeString dateFormat:(NSString *)format
{
    // 格式化时间
    ...
    // 毫秒值转化为秒
    NSDate *date = [NSDate dateWithTimeIntervalInMilliSecondSince1970:[timeString doubleValue]];
